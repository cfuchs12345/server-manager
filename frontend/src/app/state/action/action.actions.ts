...
// for effects
export const executeAction = createAction(EXECUTE_ACTION, props<{feature_id: string, action_id: string, ipaddress: string}>());
export const executeActionSuccess = createAction(EXECUTE_ACTION_SUCCESS);
export const executeActionFailure = createAction(EXECUTE_ACTION_FAILURE, props<{error: any}>());
